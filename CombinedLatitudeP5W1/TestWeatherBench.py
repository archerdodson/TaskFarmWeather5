...
from src.scoring_rules import EnergyScore, SignatureKernelRBF, MSEScore, SignatureKernel, EnergyScorePath, KernelScore, VariogramScore, PatchedScoringRule, SumScoringRules, \
    ScoringRulesForWeatherBench, ScoringRulesForWeatherBenchPatched, LossForWeatherBenchPatched, SignatureEnergyCombined
...
#####################################################################
batch_size, ensemble_size, method, nn_model, data_size, auxiliary_var_size = 16, 3, 'SR', 'unet', torch.Size([1, 32, 64]), 1  ##Consider what this auxiliar var size should be                                                                     # OR 10          #8/1
...
#--- loss function ---
sr_instance = SignatureEnergyCombined() ##### Could replace with Signature Kernel ##MSEScore ##SignatureKernel
loss_fn = sr_instance.estimate_score_batch
scoring_rule = "SignatureKernelCombined" #SignatureKernel
name_postfix = "_mytrainedmodelSignatureKernelCombined"  # or something else descriptive
